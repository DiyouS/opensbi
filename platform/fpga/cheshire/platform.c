...
#define CHESHIRE_UART_ADDR			0x3002000
...
#define CHESHIRE_PLIC_ADDR			0x4000000
#define CHESHIRE_PLIC_NUM_SOURCES	3
#define CHESHIRE_HART_COUNT			1
#define CHESHIRE_CLINT_ADDR			0x2040000
